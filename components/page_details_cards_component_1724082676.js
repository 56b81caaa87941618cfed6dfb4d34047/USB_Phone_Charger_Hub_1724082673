    ...
    <section id="page-details-cards-component" class="py-8 bg-white">
        ...
        <ul id="details-list" class="grid gap-4 min-[480px]:grid-cols-3 text-sm">
            <li id="project-length" class="px-5 py-4 rounded-lg bg-gradient-to-tr from-slate-950 to-slate-800 dark:from-slate-800/80 dark:to-slate-900">
                <div class="font-medium text-slate-200 text-slate-400">Fast Charging</div>
                <div class="text-slate-400">Our USB chargers deliver rapid power to your devices, ensuring you spend less time tethered to an outlet.</div>
            </li>
            <li id="start-date" class="px-5 py-4 rounded-lg bg-gradient-to-tr from-slate-950 to-slate-800 dark:from-slate-800/80 dark:to-slate-900">
                <div class="font-medium" id="start-date-des-1 text-slate-200 text-slate-400">Universal Compatibility</div>
                <time class="text-slate-400" id="start-time-des-1">Designed to work with all major phone brands and models, our chargers are the ultimate all-in-one solution.</time>
            </li>
            <li id="end-date" class="px-5 py-4 rounded-lg bg-gradient-to-tr from-slate-950 to-slate-800 dark:from-slate-800/80 dark:to-slate-900">
                <div class="font-medium" id="end-date-des-1 text-slate-200 text-slate-400">Compact Design</div>
                <time class="text-slate-400" id="end-time-des-1">Sleek and portable, our chargers are perfect for travel or everyday use, fitting easily in any bag or pocket.</time>
            </li>
        </ul>
    </section>
    `,
